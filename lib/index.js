...
var ModalVideo = function (_React$Component) {
  ...
  function ModalVideo(props) {
    ...
    _this.getAllowedAttribute = _this.getAllowedAttribute.bind(_this);
    return _this;
  }
  ...
  _createClass(ModalVideo, [{
    ...
    key: 'getAllowedAttribute',
    value: function getAllowedAttribute() {
      var fullscreen = this.props.allowFullScreen ? 'fullscreen' : '';
      var autoplay = this.props[this.props.channel].autoplay ? 'autoplay' : '';
